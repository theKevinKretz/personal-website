<template>
  <Head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>Kevin Kretz</title>
  </Head>

  <div>
    <img
      src="/adrien-olichon-SImgbUoEq8E-unsplash.jpg"
      class="absolute top-0 left-0 h-screen w-screen opacity-50"
    />
    <!-- Hero -->
      ...
      <div class="flex flex-col items-center max-w-7xl bg-secondary w-full m-4">
        <div class="">
          ...
          <div class="flex justify-evenly w-full m-4">
            ...
            <NuxtLink to="https://linkedin.com/in/theKevinKretz/"
              >LinkedIn</NuxtLink
            >
...
let interns = ref([
  {
    ...
    logo_url:
      "https://www.sap.com/content/dam/application/shared/logos/sap-logo-svg.svg",
  },
  {
    company: "Testo",
